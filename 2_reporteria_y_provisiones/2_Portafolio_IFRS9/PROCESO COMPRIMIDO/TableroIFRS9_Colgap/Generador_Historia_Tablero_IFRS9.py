...
def Base_Festivos():
    dfCalendario = pd.read_excel('Z:/29.Tablero_IFRS9_COLGAP_CAH/Insumos/Calendario.xlsx',sheet_name='calendario')
    dfFestivos = pd.read_excel('Z:/29.Tablero_IFRS9_COLGAP_CAH/Insumos/Calendario.xlsx',sheet_name='Festivos')
...
def Ifrs9_Colgap_Base(ingestion_year,ingestion_month,ingestion_day):
    Query_Variables_Base=""" 
      insert into  proceso_riesgos.gran_base_ifrs9_colgalp_4
    With 
...
'''
ingestion_year=['2020']
ingestion_month=['01','02','03','04','05','06','07']
ingestion_day=  ['31','29','31','30','31','30','31']#,'31','30','31','30','31']
'''
'''
ingestion_year=['2019']
...
for i in range(0,len(ingestion_month)):
    ...
    Master_Customer('2018',ingestion_month[i])
    Ifrs9_Colgap_Base('2018',ingestion_month[i],ingestion_day[i])
    print("   ╔═══════════════════════════════════════════════════════════════════════════════════════════╗")
