...
if __name__ == "__main__":
    ...
    fechas_corte = ['2021-08-08',
                   '2021-08-15'
                  ]

    fechas_corte_nmb = ['20210808',
                       '20210815' 
                      ]

    fechas_corte_ant = ['2021-08-05',
                       '2021-08-12'
                      ]

    fechas_cierre = ['2021-06-30',
                    '2021-07-31'
                   ]

    fechas_trm = ['2021-06-01',
                 '2021-07-01'
                ]

    fechas_vic_ccial = ['2021-07-31',
                       '2021-07-31'
                      ]

    fechas_matriz = ['2021-07-31',
                    '2021-07-31'
                   ]

    fechas_receta = ['2021-08-01',
                    '2021-08-01'
                   ]

    fechas_planta = ['2021-08-11',
                    '2021-08-11'
                   ]

    fechas_alivios = ['2020-10-01',
                     '2020-10-01'
                    ]
